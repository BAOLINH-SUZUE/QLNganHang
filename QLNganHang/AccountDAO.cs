...
namespace QLNganHang
{
    public class AccountDAO
    {
        ...
        public bool InsertAccount(string name, string citizenID, int type)
        {
            string query = string.Format("INSERT dbo.Account ( UserName,CitizenID, Type, password )VALUES  ( N'{0}', N'{1}', {2}, N'{3}')", name, citizenID, type, "1962026656160185351301320480154111117132155");
